...
public final class UniformRandomGenerator {
	 ...
	 *            long
	 * @param aBits
	 *            number of bits of the number-to-be-generateed
	 */
	...
	// ______________________________________________________________________________________________
	/**
	 * Returns a unique 128-bit random number. The number is also put into an internal store to check it will be never returned
	 * again
	 * 
	 * @return BigInteger
	 */
